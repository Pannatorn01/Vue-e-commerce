<script setup>
    import { ref, onMounted, toHandlers} from 'vue'
    ...
    const logout = async () => {
        ...
        window.location.reload() //reflash web
      } catch (error) {
        console.log('error', error)
      }      
    }
...
<template>
    <div class="container mx-auto">
        ...
        <div class="navbar bg-base-100">
            <div class="flex-1">
                <RouterLink :to="{ name: 'home' }" class="btn btn-ghost text-xl">PNT Card</RouterLink>
            </div>
            <div class="flex-none gap-2">
                ...
                <div tabindex="0" role="button" class="btn btn-ghost btn-circle avatar">
                    ...
                    <img :src="accountStore.profile.imageUrl || 'https://lh3.googleusercontent.com/FPaaqejSmrWmkqOpXBOpQoxDYivfwjTzCiCqy8n4ZMJoVEzy_01vJNCTu0wNZlBKaiBIRi2_7Ba_3IGhkt5elMk2D_YhKvVT1DByBQ'" />
                    </div>
                </div>
        ...
        <!-- footer -->
        <div>
            <footer class="footer footer-center p-10 bg-neutral-content text-primary-content">
                <aside>
                    ...
                    <p class="font-bold">
                    PNT Card. <br/>Providing  since 2024
                    </p> 
